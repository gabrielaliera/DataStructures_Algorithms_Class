...
public class Customer{
    ...
    public void setMinuteCalled(int min){ this.minuteCalled = min;}

    public void setMinuteServed(int min){ this.minuteServed = min;}

    public void setServiceCompleted(boolean t){ this.serviceCompleted = t;}

    //Getters
    public int getID(){ return ID;}
  
    public int getMinuteCalled(){ return minuteCalled;}

    public int getMinuteServed(){ return minuteServed;}

    public boolean getServiceCompleted(){ return serviceCompleted;}
