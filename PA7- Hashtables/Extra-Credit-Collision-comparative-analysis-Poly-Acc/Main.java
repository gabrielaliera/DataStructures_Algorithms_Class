...
class Main {
  ...
  public static void wordMap_1(String[] words){
    ...
    ChainHashMap_1<String,Integer> freq = new ChainHashMap_1<>(); 
  ...
  public static void wordMap_37(String[] words){
   
    ChainHashMap_37<String,Integer> freq = new ChainHashMap_37<>(); //use different cyclic shift
  ...
  public static void wordMap_40(String[] words){
   
    ChainHashMap_40<String,Integer> freq = new ChainHashMap_40<>(); 
  ...
  public static void wordMap_41(String[] words){
   
    ChainHashMap_41<String,Integer> freq = new ChainHashMap_41<>(); 
  ...
  public static void main(String[] args) {
    ...
    //Testcase Poly Accu 0
    System.out.println("\nTestcase Polynomial Accumulation Z=0");
    wordMap_0(words);

    //Testcase Poly Accu 1
    System.out.println("\nTestcase Polynomial Accumulation Z=1");
    wordMap_1(words);

    //Testcase Poly Accu 37
    System.out.println("\nTestcase Polynomial Accumulation Z=37");
    wordMap_37(words);

    //Testcase Poly Accu 40
    System.out.println("\nTestcase Polynomial Accumulation Z=40");
    wordMap_40(words);

    //Testcase Poly Accu 41
    System.out.println("\nTestcase Polynomial Accumulation Z=41");
    wordMap_41(words);
  }
}