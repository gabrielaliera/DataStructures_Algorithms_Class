...
class Main {
  ...
  public static void wordMap(String[] words){
    ...
    System.out.println("Collisions: "+ freq.getNumCollisions());
    // System.out.println("EntrySet:");
    // Iterable mapIter = freq.entrySet();
  ...
  public static void getCollisions(ChainHashMap<String,Integer> map){
    // UnsortedTableMap<Integer,Integer> collisions = map.getCollisionTable();
    // // Iterable mapIter = collisions.entrySet();
    // // Iterator iter = mapIter.iterator();
    ...
    System.out.println("Number of collisions: "+map.getNumCollisions());
    System.out.println("Number of collisions: "+map.size());
