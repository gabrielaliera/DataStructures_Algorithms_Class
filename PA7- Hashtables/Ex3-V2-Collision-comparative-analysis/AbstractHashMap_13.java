...
public abstract class AbstractHashMap_13<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap_13(int cap, int p) {
    prime = p;
    capacity = cap;
  ...
  public AbstractHashMap_13(int cap) { this(cap, 109345121); }  // default prime

  /** Creates a hash table with capacity 17 and prime factor 109345121. */
  public AbstractHashMap_13() { this(17); }                     // default capacity
