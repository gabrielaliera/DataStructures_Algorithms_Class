...
class Main {
  ...
  public static void main(String[] args) {
    ...
    sort.mergeSort(orignal,comp);              //Sort using mergeSort
    ...
    sort.mergeSort(random,comp);              //Sort using mergeSort
    ...
    printList(sorted);
    start = System.currentTimeMillis(); //Start time
    sort.mergeSort(sorted,comp);              //Sort using mergeSort
    finish = System.currentTimeMillis(); //End time
    time = finish -start;                //Calculate time and print 
    System.out.printf("\nSorting Runtime: %.3f ms \n", time);
    System.out.println("Data Moves: "+ sort.getDataMoves());
    ...
    start = System.currentTimeMillis(); //Start time
    sort.mergeSort(desc,comp);              //Sort using mergeSort
    finish = System.currentTimeMillis(); //End time
    time = finish -start;                //Calculate time and print 
    System.out.printf("\nSorting Runtime: %.3f ms \n", time);
    System.out.println("Data Moves: "+ sort.getDataMoves());
    ...
    start = System.currentTimeMillis(); //Start time
    sort.mergeSort(nums,comp);              //Sort using mergeSort
    finish = System.currentTimeMillis(); //End time
    time = finish -start;                //Calculate time and print 
    System.out.printf("\nSorting Runtime: %.3f ms \n", time);
    System.out.println("Data Moves: "+sort.getDataMoves());
